...
const Navbar = () => {
  ...
  // function to keep tracks wheather the user view this on phone or not
  const toggleNav = () => {
    setNav(!nav);
  };
  const closeNav = () => {
  ...
  return (
    <div className="z-50 fixed flex justify-center w-full text-white font-bold">
      <div className="border border-white/20 mt-8 backdrop-blur-lg rounded-3xl hidden md:flex items-center justify-center p-2 max-w-[400px] mx-auto">
